...
<?php include("header.php")?>
    <main class="mainBox">
        ...
        <section class="mentalyCareChild"> <!-- repèrer "symptôme"-->
            <div class="signalAlarm">
                ...
                <br>
                <p> Le mal être peut s'exprimer de façon très différentes selon les personnes. Cependant voici les "grandes lignes" qui peuvent être un bonne indice :
                    <ul>
            ...
            <div class="temoignage"> <!-- Témoignage -->
            ...
            <br>
            <div class="rdvPro"> <!-- partie prise de rendez-vous-->
                <p>
        ...
        <section class="imageAdulte"> <!-- photo fin de page-->
