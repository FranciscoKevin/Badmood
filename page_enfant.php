...
<head>
    ...
    <link rel="stylesheet" href="page_enfant.css">
            ...
            <div class="imageChild">
                ...
                <section class="blocContainerMentalyCareChild">
                    ...
                    <div class="bloc element-2"> <!-- Témoignage -->
                        <div class="video">
                        <iframe width="560" height="100%" src="https://www.youtube.com/embed/_Kz7BD98dEo" 
                        style="border:0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; 
